import unittest
from batallaNaval import cantidadDeBarcosDeTamaño
...
class cantidadDeBarcosDeTamaño_Test(unittest.TestCase):
    ...
    def test_longitud_3_hay_dos_en_el_medio(self): # Un ejemplo de test 
        barcos = [[('H',3), ('H',4), ('H',5)],
                  [('F',4), ('E',4)],
                  [('B',4), ('B',3), ('B',2)]]       
    ...
    def test_longitud_4_hay_uno_en_el_borde(self): # Un ejemplo de test 
        barcos = [[('H',3), ('H',4), ('H',5)],
                  [('F',4), ('E',4)],
                  [('B',4), ('B',3), ('B',2)],
                  [("A",1), ("A",2), ("A",3), ("A",4)]]
        self.assertEqual(cantidadDeBarcosDeTamaño(barcos,4),1)
        self.assertEqual(barcos, [[('H',3), ('H',4), ('H',5)],
                                [('F',4), ('E',4)],
                                [('B',4), ('B',3), ('B',2)],
                                [("A",1), ("A",2), ("A",3), ("A",4)]] )
        
    def test_longitud_5_hay_uno_en_el_borde(self): # Un ejemplo de test 
        barcos = [[('H',3), ('H',4), ('H',5)],
                  [('F',4), ('E',4)],
                  [('B',4), ('B',3), ('B',2)],
                  [("A",1), ("A",2), ("A",3), ("A",4), ("A",5)]]
        self.assertEqual(cantidadDeBarcosDeTamaño(barcos,5),1)
        self.assertEqual(barcos, [[('H',3), ('H',4), ('H',5)],
                                [('F',4), ('E',4)],
                                [('B',4), ('B',3), ('B',2)],
                                [("A",1), ("A",2), ("A",3), ("A",4), ("A",5)]] )
